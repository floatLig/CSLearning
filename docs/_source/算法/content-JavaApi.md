...
| :--- | :---------------------------- | :----------------------------------------------------------------------------------------------- | :------------ | :-------------------------- |
| 增加 | add(`index`, element)         | 队列：addFirst(element)<br><br> 栈：push(element)<br><br>  链表尾 add(element)                   | push(element) | put(key, value)             |
| 删除 | remove(`index`)               | 队列：removeLast()<br><br> 栈：pop()<br><br> 删除链表头 remove()<br><br> 删除链表尾 removeLast() | pop()         | remove(key)                 |
